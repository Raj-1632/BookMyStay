...
if ($paymentId && $orderId && $signature) {
    ...
    if (hash_equals($generatedSignature, $signature)) {
        ...
        if ($stmt->execute()) {
            ...
            $query = "SELECT booking_id, username, useremail, hname, userphno, checkin, checkout, hprice FROM hotel_booking WHERE order_id=?";
